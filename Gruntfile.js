...
module.exports = function (grunt) {
    ...
    try {
        ...
        grunt.log.writeln('Cannot use configuration from local.conf.json, using ' + 'default configuration instead.');
    }
    ...
    grunt.initConfig({
        ...
        replace: {
            ...
            hackUrls: {
                // hack to solve problem with css-min url rewriting
        ...
        concurrent: {
            server: ['copy:styles', 'sprite:ui', 'sprite:units', 'sprite:strategic'],
            test: ['copy:styles'],
    ...
    grunt.registerTask('serve', function (target) {
        ...
        grunt.task.run(['clean:server', 'bower', 'concurrent:server', 'autoprefixer', 'connect:livereload', 'watch']);
    });
