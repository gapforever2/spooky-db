...
describe('dps', function () {
    ...
    it('Valiant Class (UES0201) - Gauss Cannon', function () {
        var weapon = {
            ...
            ProjectilesPerOnFire: 1,
            TurretYaw: 0,
            RackBones: [{ MuzzleBones: ['Front_Turret01_Muzzle01'] }, { MuzzleBones: ['Front_Turret01_Muzzle02'] }],
            Damage: 275,
            DamageType: 'Normal',
            TurretPitch: 10,
            TurretPitchRange: 20,
    ...
    it('Cooper (XES0102) - Angler Torpedo', function () {
        var weapon = {
            RateOfFire: 0.3,
            TurretYaw: 0,
            RackBones: [{ MuzzleBones: ['Projectile01'] }],
            Damage: 80,
    ...
    it('Vesper (XAS0204) - Chrono Torpedo', function () {
        var weapon = {
            RateOfFire: 0.25,
            TurretYaw: 0,
            RackBones: [{ MuzzleBones: ['Projectile_Front_Right', 'Projectile_Front_Left'] }],
            Damage: 90,
            ProjectileLifetime: 7,
            DamageType: 'Normal',
            TurretPitch: 0,
    ...
    it('Lobo (UEL0103) - Fragmentation Artillery', function () {
        var weapon = {
            ...
            TurretYaw: 0,
            RackBones: [{ MuzzleBones: ['Turret_Muzzle'] }],
            Damage: 100,
            DamageType: 'Normal',
            TurretPitch: 45,
            TurretPitchRange: 90,
    ...
    it('Sinnve (XSA0103) - Othe Tactical Bomb', function () {
        var weapon = {
            ...
            RateOfFire: 0.2,
            ProjectilesPerOnFire: 1,
            RackBones: [{ MuzzleBones: ['Center_Projectile'] }],
            Damage: 250,
            DamageType: 'Normal',
