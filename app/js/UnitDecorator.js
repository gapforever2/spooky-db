...
unitDb.UnitDecorator = function (blueprint) {
    ...
    const gdiBaseClassificationLookupAndOrder = {
        'Construction - Buildpower': ['T1 Engineer', 'T2 Engineer', 'T2 Field Engineer', 'T3 Engineer', 'T3 Support Armored Command Unit', 'Armored Command Unit', 'ACU Engineering Drone', 'T2 Engineering Drone', 'T2 Engineering Station', 'T3 Engineering Station'],
        ...
        'Air': ['T1 Interceptor', 'T1 Attack Bomber', 'T1 Light Gunship', 'T1 Air Scout', 'T1 Light Air Transport', 'T2 Combat Fighter', 'T2 Fighter/Bomber', 'T2 Gunship', 'T2 Torpedo Bomber', 'T2 Guided Missile', 'T2 Air Transport', 'T3 Air Superiority Fighter', 'T3 Strategic Bomber', 'T3 Heavy Gunship', 'T3 Anti-Air Gunship', 'T3 Torpedo Bomber', 'T3 Torpedo Gunship', 'T3 Spy Plane', 'T3 Heavy Air Transport'],
    ...
    const weaponStats = (weapon) => {
        ...
        const salvoDelay = +((weapon.MuzzleSalvoDelay ?? 1) === 0 ? 0 : (weapon.MuzzleSalvoDelay ?? 1) - 0.1).toFixed(1);
